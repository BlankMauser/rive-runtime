...
/**
* @file
* @brief  Declarations of API resources for device data (NVN8 special edition).
*/
...
/**
* @brief  The structure representing a device (NVN8 special edition).
*/
template<>
struct DeviceImplData< ApiVariationNvn8 >
{
    ...
    nn::util::BitPack32 supportedFeatures; //!<  Supported features.

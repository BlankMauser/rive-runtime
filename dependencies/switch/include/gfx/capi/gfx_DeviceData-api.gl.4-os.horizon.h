...
struct DeviceImplData< ApiVariationGl4 >
{
    ...
    uint32_t alignmentConstantBuffer; //!<  The alignment for the constant buffer.
    uint32_t alignmentUnorderedAccessBuffer; //!<  The alignment for the unordered access buffer.
    detail::Ptr< void > hDisplay; //!<  The display handle.
    detail::Ptr< void > hSurface; //!<  The surface handle.

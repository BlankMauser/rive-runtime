...
/**
* @file
* @brief  Declarations of API resources for the data in the information used to initialize a sampler (NVN8 special edition).
*/
...
/**
* @brief  The structure representing information for initializing a sampler (NVN8 special edition).
*/
template<>
struct SamplerInfoImplData< ApiVariationNvn8 >
{
    NVNsamplerBuilder nvnSamplerBuilder; //!<  The <tt>nvn</tt> sampler builder.

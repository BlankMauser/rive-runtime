...
/**
* @file
* @brief  Common input configuration for the <tt>gfx</tt> library API.
*/
...
#define NN_GFX_CONFIG_API_EX NN_GFX_MAKE_API_TYPE_VERSION( NN_GFX_CONFIG_API_TYPE_EX, NN_GFX_CONFIG_EX_DEFAULT_VERSION )
...
#define NN_GFX_CONFIG_API_EX1 NN_GFX_MAKE_API_TYPE_VERSION( NN_GFX_CONFIG_API_TYPE_EX, 1 )
...
#define NN_GFX_CONFIG_API_TYPE_EX 6
...
#define NN_GFX_IS_TARGET_EX NN_GFX_IS_API_TYPE( NN_GFX_CONFIG_API_TYPE_EX )
...
#define NN_GFX_CONFIG_TARGET_LINUX_DEFAULT NN_GFX_CONFIG_API_VK
...
#define NN_GFX_CONFIG_EX_DEFAULT_VERSION 1

// If NN_GFX_CONFIG_TARGET_API is not defined.
    ...
    #elif defined( NN_BUILD_CONFIG_OS_SUPPORTS_LINUX )
        #define NN_GFX_CONFIG_TARGET_API NN_GFX_CONFIG_TARGET_LINUX_DEFAULT
    #elif defined( NN_BUILD_CONFIG_OS_SUPPORTS_COS )
        #define NN_GFX_CONFIG_TARGET_API NN_GFX_CONFIG_TARGET_COS_DEFAULT
    #else
        #error  "Cannot find an appropriate low-level graphics API."
    #endif
#endif

// Always include the target API.
...
#if NN_GFX_IS_TARGET_EX
    #if !defined( NN_GFX_CONFIG_INCLUDE_EX )
        #define NN_GFX_CONFIG_INCLUDE_EX 1
    #endif
    #if NN_GFX_IS_TARGET_VERSION( 1 )
        #if !defined( NN_GFX_CONFIG_INCLUDE_EX1 )
            #define NN_GFX_CONFIG_INCLUDE_EX1 1
        #endif
        #if !defined( NN_GFX_CONFIG_EX_TARGET_VERSION )
            #define NN_GFX_CONFIG_EX_TARGET_VERSION 1
        #endif
    #endif
#endif

/*If only one version is specified, that is the target version.
#if ! defined(NN_GFX_CONFIG_D3D_TARGET_VERSION)
...
// If NN_GFX_CONFIG_*_TARGET_VERSION is not defined.
#if !defined( NN_GFX_CONFIG_GL_TARGET_VERSION )
...
#endif
#if !defined( NN_GFX_CONFIG_EX_TARGET_VERSION )
    #define NN_GFX_CONFIG_EX_TARGET_VERSION NN_GFX_CONFIG_EX_DEFAULT_VERSION
#endif

// If specified with a version, define one without a version.
#if !defined( NN_GFX_CONFIG_INCLUDE_GL )
    #if defined( NN_GFX_CONFIG_INCLUDE_GL4 )
...
// Always include the target version.
#if defined( NN_GFX_CONFIG_INCLUDE_GL )
...
#endif
#if defined( NN_GFX_CONFIG_INCLUDE_EX )
    #if !defined( NN_GFX_CONFIG_INCLUDE_EX1 ) && NN_GFX_CONFIG_EX_TARGET_VERSION == 1
        #define NN_GFX_CONFIG_INCLUDE_EX1 1
    #endif
#endif
...
#elif NN_GFX_IS_TARGET_EX
    #define NN_GFX_TARGET_API_SUFFIX NN_GFX_EX_SUFFIX
#endif
...
#define NN_GFX_EX_TARGET_SUFFIX \
    NN_GFX_MAKE_SUFFIX(NN_GFX_EX_SUFFIX, NN_GFX_CONFIG_EX_TARGET_VERSION)

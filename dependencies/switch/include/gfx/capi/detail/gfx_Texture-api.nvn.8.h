...
public:
    ...
    static void CalculateMipDataSizeAndAlignment( size_t *pOutSize, size_t *pOutAlignment, DeviceImpl< Target > *pDevice, const InfoType& info ) NN_NOEXCEPT;
    static void CalculateMipDataSizeAndAlignment( size_t *pOutSize, size_t *pOutAlignment, DeviceImpl< Target > *pDevice, const TextureInfoImpl< Target >& info ) NN_NOEXCEPT;

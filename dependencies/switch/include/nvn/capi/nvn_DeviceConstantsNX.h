...
#define NVN_DEVICE_INFO_CONSTANT_NX_GLSLC_MAX_SUPPORTED_GPU_CODE_MINOR_VERSION     16
...
#define NVN_DEVICE_INFO_CONSTANT_NX_SHADER_SUBGROUP_SIZE                           32

/// \brief Maximum size (in bytes) of dynamic checkpoint marker data.
#define NVN_DEVICE_INFO_CONSTANT_NX_CHECKPOINT_MAXIMUM_DYNAMIC_MARKER_DATA_SIZE    256

/// \brief Maximum number of call stack entries that can be captured for
/// checkpoint event markers.
#define NVN_DEVICE_INFO_CONSTANT_NX_CHECKPOINT_MAXIMUM_CALL_STACK_CAPTURE_DEPTH    16

/// \brief Maximum supported length of the event sampling interval for
/// automatic checkpoint event markers.
#define NVN_DEVICE_INFO_CONSTANT_NX_CHECKPOINT_MAXIMUM_SAMPLING_INTERVAL_LENGTH    65535

/// \brief Maximum size (in bytes) of static checkpoint marker data.
#define NVN_DEVICE_INFO_CONSTANT_NX_CHECKPOINT_MAXIMUM_STATIC_MARKER_DATA_SIZE     65535

/// \brief Minimum alignment of shader code bindings.
#define NVN_DEVICE_INFO_CONSTANT_NX_SHADER_CODE_ALIGNMENT                          256
...
#define NVN_DEVICE_INFO_CONSTANT_NX_VERTEX_ATTRIBUTE_STATE_MAXIMUM_RELATIVE_OFFSET 16383

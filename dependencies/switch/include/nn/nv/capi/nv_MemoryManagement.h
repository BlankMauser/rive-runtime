...
namespace nv {
    ...
    /**
     * @brief  Alignment required for the memory passed to nv::InitializeGraphics
     */
    const size_t GraphicsMemoryAlignment = nn::os::MemoryPageSize;

    /**
     * @brief  Granularity size for the memory passed to nv::InitializeGraphics
     */
    const size_t GraphicsMemoryGranularity = nn::os::MemoryPageSize;
...
//! @{
     ...
     *                          Must be aligned to nv::GraphicsMemoryAlignment.
     *   @param[in]  size       Size of memory being donated to graphics firmware.
     *                          Must be a multiple of nv::GraphicsMemoryGranularity.
     */
     ...
     *   Initialized resources for all graphics APIs must be released before
     *   calling nv::FinalizeGraphics to release all allocated memory resources.
     *   nv::FinalizeGraphics releases memory resources indirectly allocated in
     *   graphics subsystem.
     */

...
namespace nn
{
    namespace os
    {
        ...
        void ClearSystemEvent(nn::os::SystemEventType* event);
        void DestroySystemEvent(nn::os::SystemEventType* event);
        void WaitSystemEvent(nn::os::SystemEventType* event);
        bool TryWaitSystemEvent(nn::os::SystemEventType* event);
        bool TimedWaitSystemEvent(nn::os::SystemEventType* event);

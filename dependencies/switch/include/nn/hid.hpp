...
namespace nn
{
    namespace hid
    {
        ...
        int GetNpadStates(nn::hid::NpadGcState *outArray, s32 count, u32 const &controllerID);
        ...
        void GetNpadState(nn::hid::NpadGcState *out, u32 const &controllerID);
        int ShowControllerSupport(nn::hid::ControllerSupportResultInfo *, ControllerSupportArg const&);

        void InitializeMouse();
        void GetMouseState(MouseState* out);
